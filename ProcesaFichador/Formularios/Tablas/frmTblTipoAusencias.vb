...
Public Class frmTblTipoAusencias
    Inherits frmBase
...
#Region "Formato Controles"
    Private Sub FormatoGrillas()
        Try
            ...
            GridView1.Columns.Add(NewColumn("JUSTIFICADA", "Justificada"))
            GridView1.Columns.Add(NewColumn("ACTIVO", "Activo"))
            GridView1.Columns.Add(NewColumn("PIERDEPRESENTISMO", "Pierde Presentismo"))
...
#Region "Eventos controles"
    ...
    Sub OnDeleteRowClick(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Select Case item.Caption
            ...
            Case "Inactivar Registro" : Call EliminarItem(info.RowHandle)
        End Select
    End Sub
...
#Region "Procedimientos y Eventos"
    ...
    Private Sub EditarItem(ByVal iRow As Integer)
        ...
        Try
            entity = CType(GridView1.GetRow(iRow), TipoAusencia)
            If Not entity Is Nothing Then
                Dim frm As New FrmAbmTipoAusencia
                frm.Entity = entity
                frm.ShowDialog()
    ...
    Private Sub PreviewPrintableComponent(component As IPrintable, lookAndFeel As UserLookAndFeel)
        ...
        phf.Header.Content.AddRange(New String() {"", "Listado de Tipo Ausencias", "[Image 0]"})
    ...
    Private Sub cargarGrilla()
        Dim obj As New TipoAusenciaComponent(Session.CadenaConexion)
        Dim List As List(Of TipoAusencia)
